...
public class HideCheckPictureActivity extends Activity implements OnClickListener{
	...
	public void refreshImageViewList(){
		ArrayList<String> list = DB_Provider.getPicPath(id);
		if(imageList != null){
			imageList.clear();
			if(list !=null){
	...
	public void onClick(View arg0) {
		...
		case R.id.newphoto_del:
			AlertDialog dialog = new AlertDialog.Builder(HideCheckPictureActivity.this)
			.setTitle("提示")
			.setMessage("是否删除？")
					...
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog,
							...
							for(Map.Entry<String, String> m : mCachePicMap.entrySet()){
								DB_Provider.delHidecheckpic(m.getKey());
	...
	private void openCamera() {
		String sdStatus = Environment.getExternalStorageState();
		 ...
		 String fileDir = Environment.getExternalStorageDirectory().getPath() + "/TYPIC"+ "/hidecheckpic/"+ id+"/";
