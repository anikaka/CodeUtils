...
public class DownloadService extends Service {
	...
	private void downloadFile() {
		mDownloadThread = new Thread(downuplaodFileRunnable);
...
//		mCallback.onBackResult("finish");
	...
	private Runnable downuplaodFileRunnable = new Runnable() {
			...
			try {
				...
				String sdStatus = Environment.getExternalStorageState();
				 if (!sdStatus.equals(Environment.MEDIA_MOUNTED)) { // 检测sd是否可用
		        	 ...
		        	 String apkDir = Environment.getExternalStorageDirectory().getPath() + Constants.PATH_OF_APK;
//		        	 String apkPath = apkDir + fileNa + "." + fileEx;
		        	 String apkPath = apkDir +"TYSubwayClientZZ." + fileEx;
	...
	private void setUpNotification() {
		...
		mNotification = new Notification(R.drawable.common_arrow, tickerText, System.currentTimeMillis());
		// 放置在"正在运行"栏目中
