 ...
 */
public class MDateTimePickerDialog extends AlertDialog implements
		OnClickListener{
	...
	public MDateTimePickerDialog(Context context,
			OnDateTimeSetListener callBack) {
		this(context, START_YEAR,END_YEAR,callBack);
	}

	public MDateTimePickerDialog(Context context, final int START_YEAR,
		...
		View view = inflater.inflate(R.layout.common_time_picker_layout, null);
