package com.tongyan.zhengzhou.common.widgets.datetime.wheelview;
 ...
 */
public class MDatePickerNoDayDialog extends AlertDialog implements
		OnClickListener{
	...
	public MDatePickerNoDayDialog(Context context, int mScreenWidth, OnDateTimeSetListener callBack) {
		this(context,mScreenWidth, START_YEAR,END_YEAR, callBack);
	}

	public MDatePickerNoDayDialog(Context context, int mScreenWidth, final int START_YEAR,
		...
		View view = inflater.inflate(R.layout.common_date_picker_no_day_layout, null);
		...
		wv_year.setLayoutParams(new android.widget.LinearLayout.LayoutParams((int)(mScreenWidth * 0.2), LayoutParams.WRAP_CONTENT));
		...
		wv_month.setLayoutParams(new android.widget.LinearLayout.LayoutParams((int)(mScreenWidth * 0.1), LayoutParams.WRAP_CONTENT));
		// 日
	...
	public void onClick(DialogInterface dialog, int which) {
		...
		if (mCallBack != null) {
			mCallBack.onDateTimeSet(curr_year, curr_month);
		}
	}
	 public void show() {
	        super.show();
