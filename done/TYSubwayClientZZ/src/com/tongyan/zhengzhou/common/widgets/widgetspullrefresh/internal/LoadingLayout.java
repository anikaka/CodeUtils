package com.tongyan.zhengzhou.common.widgets.widgetspullrefresh.internal;




import com.tongyan.zhengzhou.act.R;
import com.tongyan.zhengzhou.common.widgets.widgetspullrefresh.PullToRefreshBase;
...
public class LoadingLayout extends FrameLayout {
	...
	public LoadingLayout(Context context, final int mode, String releaseLabel, String pullLabel, String refreshingLabel) {
		super(context);
		ViewGroup header = (ViewGroup) LayoutInflater.from(context).inflate(R.layout.common_pull_to_refresh_header_a, this);
		...
		switch (mode) {
			case PullToRefreshBase.MODE_PULL_UP_TO_REFRESH:
				headerImage.setImageResource(R.drawable.p00_widget_pulltorefresh_up_arrow);
				break;
			case PullToRefreshBase.MODE_PULL_DOWN_TO_REFRESH:
			default:
				headerImage.setImageResource(R.drawable.p00_widget_pulltorefresh_down_arrow);
				break;
		}
	}
