package com.tongyan.yanan.tfinal.https;
...
public class HttpUtils {
     ...
     */
    public static HttpResponse httpGet(HttpRequest request) throws MalformedURLException,IOException{
        if (request == null) {
            return null;
        }
     ...
     */
    public static HttpResponse httpGet(String httpUrl) throws MalformedURLException, IOException {
     ...
     * @see HttpUtils#httpGet(HttpRequest)
     */
    public static String httpGetString(HttpRequest request) throws MalformedURLException, IOException {
     ...
     * @see HttpUtils#httpGet(HttpRequest)
     */
    public static String httpGetString(String httpUrl) throws IOException {
    	Log.i("test", "temp"+httpUrl);
     ...
     */
    public static String getUrlWithParas(String url, Map<String, String> parasMap, Context mContext) {
    	url = getCacheUrl(mContext,url);//To get all path
     ...
     * @return
     */
    public static String getCacheUrl(Context mContext, String mSubUrl) {
    	...
    	return Constants.HTTP + mPath + mSubUrl;
    }
