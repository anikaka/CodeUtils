...
package com.tongyan.yanan.tfinal.http;
...
public class AsyncHttpClient {
    ...
    public AsyncHttpClient(SchemeRegistry schemeRegistry) {
      ...
      //拦截器3
        ...
        httpClient.setHttpRequestRetryHandler(new RetryHandler(DEFAULT_MAX_RETRIES, DEFAULT_RETRY_SLEEP_TIME_MILLIS));// 5 1500
    }
