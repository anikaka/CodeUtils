 ...
 * @desc TODO
 */
public class OaContactsDepartmentAdapter extends BaseAdapter {
	
	private LayoutInflater layoutInflater;
	private OnClickListener onClickListener;
	private ArrayList<HashMap<String, String>> stringArr;
	
	public OaContactsDepartmentAdapter(Context context, ArrayList<HashMap<String, String>> arr, OnClickListener listener) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		int idx = position - 1;
		String previewChar = idx >= 0 ? stringArr.get(idx).get("DeptNamePinyin") : "";
		
		String currentChar = map.get("DeptNamePinyin");
		
		if (currentChar != null && !currentChar.equals(previewChar)) {
			holder.firstCharHintTextView.setVisibility(View.VISIBLE);
			holder.firstCharHintTextView.setTextColor(Color.parseColor("#11354d"));
			holder.firstCharHintTextView.setText(map.get("DeptName"));
		} else {
