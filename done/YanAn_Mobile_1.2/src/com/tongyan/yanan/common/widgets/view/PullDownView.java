...
import com.tongyan.yanan.common.widgets.view.ScrollOverListView.OnScrollOverListener;
...
public class PullDownView extends LinearLayout implements OnScrollOverListener{
	...
	private void initHeaderViewAndFooterViewAndListView(Context context){
		...
		mHeaderLoadingView =(View) mHeaderView.findViewById(R.id.pulldown_header_loading);
