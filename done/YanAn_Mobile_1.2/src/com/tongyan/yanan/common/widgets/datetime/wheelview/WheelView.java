package com.tongyan.yanan.common.widgets.datetime.wheelview;
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.common_datepicker_wheel_val);
		}
		...
		setBackgroundResource(R.drawable.common_datepicker_wheel_bg);
	}
