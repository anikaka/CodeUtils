...
public class CommandFileAdapter  extends BaseAdapter{
	...
	public CommandFileAdapter(Context context,ArrayList<HashMap<String, String>> linkedListFile,int resoureId){
